...
{
  Log::write(std::string(__func__) + " was invoked");
...
void SBomber::ProcessKBHit(int amountInputtedCodes) {
  ...
  Log::write(std::string(__func__) + " was invoked. key = "+std::to_string(static_cast<int>(c)));
...
void SBomber::TimeFinish() {
  ...
  Log::write(std::string(__func__) + " deltaTime = " + std::to_string( (int)deltaTime));
}
